...
@Fork(5)
public class FalseCacheSharingBenchmark {
    ...
    public int reader(StateBaseline s, Blackhole blackhole) {
    	blackhole.consume(s.readOnly);
        return s.readOnly;
    }
...
//        @sun.misc.Contended
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(".*" + FalseCacheSharingBenchmark.class.getSimpleName() + ".*")
